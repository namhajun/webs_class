            ...
            <div class="container">
                ...
                <div class="board__inner">
                    <div class="board__search">
                        <form action="boradSearch.php" name="boardSearch" method="get">
                            <fieldset>
...
<?php
    ...
    $sql = "SELECT b.boardID, b.boardTitle, m.youName, b.regTime, b.boardView FROM myBoard b JOIN myMember m ON(m.memberID = b.memberID)";
    ...
    if($result){
        ...
        if($count > 0){
            for($i=1; $i<=$count; $i++){
                ...
                echo "<td class='left'><a href='boardView.php'>".$boardInfo['boardTitle']."</a></td>";
